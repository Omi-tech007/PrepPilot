...
const getThemeStyles = (themeName) => {
  ...
  const map = {
    ...
    'Violet': { bg: 'bg-violet-600', hover: 'hover:bg-violet-700', text: 'text-violet-500', border: 'border-violet-500', light: 'bg-violet-500/20', stroke: '#8b5cf6', ring: 'ring-violet-500' },
    'Amber': { bg: 'bg-amber-600', hover: 'hover:bg-amber-700', text: 'text-amber-500', border: 'border-amber-500', light: 'bg-amber-500/20', stroke: '#f59e0b', ring: 'ring-amber-500' },
